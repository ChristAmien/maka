export const links = [
    ...
    { href: "#nosPensés", label: "Nos pensés" },
    { href: "#Sorties", label: "Sorties" },
]


export const photos = [
    { src: "/gallery/1.png", alt: "Souvenir 1", span: "row-span-2" },
    { src: "/gallery/2.png", alt: "Souvenir 2", span: "row-span-2" },
    { src: "/gallery/3.png", alt: "Souvenir 3", span: "row-span-2" },
    { src: "/gallery/4.png", alt: "Souvenir 4", span: "row-span-2" },
    { src: "/gallery/5.png", alt: "Souvenir 5", span: "row-span-2" },
    { src: "/gallery/6.png", alt: "Souvenir 6", span: "row-span-2" },
    { src: "/gallery/7.png", alt: "Souvenir 7", span: "row-span-2" },
...
export const tracks = [
    {
        title: "Notre chanson",
        note: "Celle qu'on écoutait en boucle",
        embedUrl: "https://open.spotify.com/embed/track/1hGFBoijeuBRjBrKR2zfgv?utm_source=generator&si=019a063ceaa34c4d",
    },
    {
        title: "Souvenir d'aniverssaire de Deep",
        note: "Le son de nos meilleures sorties",
        embedUrl: "https://open.spotify.com/embed/track/67357csxlbTop7i2ZpWQDQ?utm_source=generator&si=794ce3edd6354778"
    },
    {
        title: "Ta chanson Péférer 🥰 (vas savoir pourquoi mon cher)",
        note: "Spécialement pour ton anniversaire ",
        embedUrl: "https://open.spotify.com/embed/track/1lQGfiIqrzHj9YF2vH94Ec?utm_source=generator&si=dfbc8575db2c4727",
    },
    {
        title: "Pour Ton couple avec mon Ami",
        note: "Deep T'aime ma camarade 🥰",
        embedUrl: "https://open.spotify.com/embed/track/2rwwGHau31uBDv18ehgWtT?utm_source=generator&si=85c466ae444d49e0",
    },
]
...
export const outings = [
    {
        id: "Porc Day ?",
        title: "Porc Day",
        desc: "Une belle table, un bon repas, et plein de discussions.",
        image: "/sorties/restaurant.png",
    },
    {
        id: "kiffement",
        title: "Journée Tous ensemble avec la Bande",
        desc: "Boisson,Nourriture,Safe place et détente toute la journée.",
        image: "/sorties/kiffement.png",
    },
    {
        id: "cinema",
        title: "Ciné + resto",
        desc: "Un bon film suivi d'une pause sucrée quelque part.",
        image: "/sorties/cinema.png",
    },
    {
        id: "surprise",
        title: "Surprise totale",
        desc: "Tu nous fais confiance, ont s'occupent de tout.",
        image: "/sorties/suprise.png",
    },
]
...
Bisous je t’aime`,
    },
    {
        id: 3,
        name: "Kelly",
        avatar: "/messages/kelly.png",
        text: `Joyeux anniversaire à mon bébé Karel.🎂✨
En ce jour spécial, je te souhaite le meilleur: la santé, le bonheur, la réussite dans tout ce que tu entreprends et beaucoup d'amour.

Reste cette belle personne que tu es, forte et souriante. Que Dieu t'ouvre les portes de ton avenir.
...
Kelly 😘❤️`,
    },
    {
        id: 4,
        name: "Alexandra",
        avatar: "/messages/alexandra.png",
        text: `Chère Karel,

Aujourd'hui, c'est ton jour et je veux en profiter pour te dire quelque chose.
Déjà, je remercie Dieu de t'avoir mise dans ma vie. On se connaît depuis petites, on a grandi ensemble, on s'est éloignées, puis on s'est rapprochées sans même nous en rendre compte.
Merci d'être toujours là pour moi. Merci de me pousser vers le haut. Merci parce que la majorité de mes objectifs ont été atteints grâce à toi, parce que tu as cru en moi et que tu m'as toujours encouragée.
Tu es plus qu'une amie pour moi, tu es une sœur. Une sœur qui compte énormément à mes yeux. ❤️
Que le Seigneur te bénisse et qu'Il t'accorde tous les désirs de ton cœur. N'oublie jamais que je suis là si tu as besoin de moi, à n'importe quel moment.
Je veux aussi te dire de croire en toi. « Tout est possible à celui qui croit. » Ne l'oublie jamais !!!
Enfin, je veux terminer en te souhaitant un joyeux et doux anniversaire, ma sœur ! ❤️❤️ Profite à fond de ta journée avec les personnes qui t'aiment et qui te sont chères.
Je t'aime !! Bisous 😘
Alexandra`,
    },
    {
        id: 5,
        name: "Stephy",
        avatar: "/messages/stephy.png",
        text: `Joyeux anniversaire Karel

En ce jour si spécial qui est le tien, je voulais prendre le temps de t'écrire un vrai message, qui vient du coeur.

D'abord, je veux te souhaiter le meilleur. Je te souhaite une vie remplie de bonheur, de santé, de paix et de succès. Que cette nouvelle année t'apporte tout ce que tu attends, que tous tes projets se réalisent, que tu sois entourée d'amour et de personnes qui t'aiment autant que tu sais aimer les autres. Tu le mérites tellement. Tu es une belle personne, avec une âme généreuse et une lumière qu'on n'oublie pas.

Et ensuite, je veux te dire merci. Un grand merci.

Merci parce que mon bonheur d'aujourd'hui porte ton nom. C'est grâce à toi que j'ai rencontré ta meilleure amie. C'est toi qui as cru en nous, qui as créé le lien, qui nous as rapprochés avec bienveillance et sans rien attendre en retour. Grâce à toi, je suis aujourd'hui en couple avec une femme formidable, et je vis un bonheur sincère et profond dont je voulais.

Ce que tu as fait pour moi est inestimable. Tu n'as pas seulement présenté deux personnes, tu as offert le bonheur à deux personnes. Et ça, je ne l'oublierai jamais.

Alors aujourd'hui, je célèbre ton anniversaire, mais je célèbre aussi ton grand coeur. Reste cette personne exceptionnelle que tu es. Que la vie te rende au centuple tout le bien que tu fais autour de toi.

Joyeux anniversaire Karel, avec toute ma reconnaissance et toute mon amitié.
...
Stephy`,
    },
    {
        id: 6,
        name: "Michel KOUE Bi",
        avatar: "/messages/michel.png",
        text: `Joyeux anniversaire à toi, ma chère Marie Karel ❤️🎂

En ce jour particulier, je veux prendre un petit moment pour te dire à quel point je suis heureux de te connaître et de pouvoir te compter parmi mes amies.

Tu es une personne belle, intelligente et surtout profondément généreuse. J'admire particulièrement l'amour que tu portes aux enfants et cette façon que tu as de te donner à cœur joie pour eux, même lorsque la fatigue se fait sentir. C'est une belle partie de toi qui mérite d'être reconnue.

Bon… il faut aussi avouer que tu as ton petit caractère 😅. Tu peux être assez sanguine par moments et donner l'impression, à ceux qui ne te connaissent pas vraiment, d'être une personne très nerveuse. Mais ceux qui prennent le temps de te découvrir savent qu'au fond, tu es douce, sensible et attachante. Et je pense que c'est aussi ce qui fait ton charme.

Je suis sincèrement heureux que nos chemins se soient croisés et de pouvoir dire que tu es une bonne amie. Je te souhaite de continuer à avancer, à grandir et à progresser dans tous les domaines de ta vie.
Que Dieu t'accorde les désirs de ton cœur, qu'Il guide chacun de tes pas, te donne la force de surmonter tes difficultés et t'accorde les opportunités nécessaires pour devenir pleinement la femme que tu souhaites être.

Que cette nouvelle année de ta vie soit remplie de bonheur, de belles rencontres, de réussites, de paix et surtout de beaucoup de raisons de sourire. ❤️

Profite pleinement de ta journée, Marie Karel. Tu le mérites vraiment.

Joyeux anniversaire encore une fois ! 🎉🥳❤️
...
Michel KOUE Bi`,
    },
    {
        id: 7,
        name: "Ariel",
        avatar: "/messages/ariel.png",
        text: `Yo Marie-Karel ! Sdk fils, bah moi ça va oklm…heuu voilà, une occasion nous a été offerte pour parler un peu de notre ressenti envers toi et de nos souhaits pour toi alors vsy so, tu sais que je t'ai jamais caché que tu mérites le meilleur. T'es belle, intelligente et c'est okay quoi fin merci pour cette amie que tu es avec qui je peux parler de tout (hum🤣) et merci aussi de me faire confiance lorsque tu as besoin d'aide, de soutien émotionnel, de conseils et puis tu sais que moi je cache pas mes trucs je dis la vérité ahhh bref…j'espère aussi que j'arrive vraiment à t'aider car moi aussi ça me fait beaucoup plaisir de le faire et de te raconter mes trucs, merci d'être toujours présente pour moi (btw compta là merci tchiee😭) fin on a parlé de trop de trucs ici tchai je vais pas tout dire mais franchement merci…tu représentes beaucoup pour moi et je bénis Dieu pour ta vie et pour celle de ta famille, que Dieu te bénisse et qu'il te donne de croître à tous les niveaux. Que par ces quelques mots qui d'ailleurs ne pourront pas tout dire de toi, tu sois contente et que tu puisses dire (tiens, voici quelqu'un qui tiens beaucoup à moi 🫵🏽) parce que fin c'est le cas.

JOYEUX ANNIVERSAIRE MARIE-KAREL🥳🤍🤍🤍🍾

Je vais tomber sur toi un de ces quatres on va se faire un porc (sans Lumina)🙄🚶🏾🚶🏾
...
ARIEL`,
    },
    {
        id: 8,
        name: "Evariste",
        avatar: "/messages/evariste.png",
        text: `Ma chère Karel,
Je voulais profiter de ton anniversaire pour te dire à quel point ta présence compte pour moi. Tu n'es pas seulement une formidable petite sœur, tu es une amie précieuse sur qui je sais pouvoir toujours compter.
Voir la personne généreuse, forte et lumineuse que tu deviens est un vrai bonheur au quotidien. Notre complicité et tous ces moments partagés sont des trésors que je chéris énormément.
Je te souhaite un merveilleux anniversaire, rempli de rires, de douceur et de tous les succès que tu mérites tant. Merci d'être la belle personne que tu es.
Joyeux anniversaire Karel.
...
Evariste 🤗`,
    },
    {
        id: 9,
        name: "Esther Yoboué",
        avatar: "/messages/esther-yobouet.png",
        text: `Merci d'exister Karel,
J'ai tellement de raison de remercier Dieu pour ton existence mais je vais juste en citer deux.
Nous nous sommes connues en 2016 au collège moderne du plateau, étant une personne très réservée je t'ai eu comme amie...je n'avais pas forcément d'amis à cette époque car je me sentais moindre devant les autres, je pensais que je n'étais personne et que je n'avais pas de valeur, je me suis vraiment accrochés à l'amitié que j'ai eu avec vous (toi et les autres) à cette époque, tu m'as poussé vers le haut et m'a appris a exprimé ce que je pensais.
Malheureusement, tu nous a laissé en 3ème.

La deuxième raison c'est récemment, lorsque j'étais dans ce chagrin amoureux...tu n'as pas minimisée mon ressenti, tu m'as écouté et tu m'as donné de bon conseil, grâce à toi j'ai pu sortir de cette prison dans laquelle j'étais.

Je remercie Dieu pour ta vie et je souhaite que sois heureuse et épanouie ; dans les études, dans ta famille, dans tes mouvements, dans tes relations amoureuses et amicale.

Merci d'exister Karel, Que Dieu te bénisse.
...
Esther Yoboué.`,
    },
    {
        id: 10,
        name: "Junior",
        avatar: "/messages/junior.png",
        text: `Cc Akissi electrique, je t'écris pour te souhaiter un bel et joyeux anniversaire, qu'en ce jour béni Dieu t'accorde encore plus de joie de vivre, de bénédiction et une santé parfaite, Que cette année de plus soit le déclic pour l'ouverture de plusieurs portes de réussite pour toi. Tu es une très belle personne, ne laisse personne te dire le contraire et tu peux être fière de toi. Merci pour l'amie, la sœur que t'es.

GOD BLESS YOU profite au Max 🙂❤️

Junior`,
    },
    {
        id: 11,
        name: "Admirateur secret ✉️",
...
Et qui sait… peut-être que ce message ne sera pas seulement un message d’anniversaire, mais le début d’une nouvelle aventure 🤍❤️`,
    },
    {
        id: 12,
        name: "Lumina",
        avatar: "/messages/lumina.png",
        text: `À toi marie Karel ma grande sœur de cœur,
Aujourd'hui c'est ton jour et je ne pouvais pas ne pas le laisser passer sans te souhaiter un joyeux anniversaire à toi la personne la plus formidable qui existe et la plus compréhensible, tu comptes beaucoup pour moi. Que cette nouvelle année t'apporte tout ce que ton cœur désire, que Dieu continue de te bénir et apaise toutes tes peines que tu portes seul, encore un joyeux anniversaire, Je t'aime bien fort l'aînée ❤️❤️.
...
Lumina`,
    },
    {
        id: 13,
        name: "Jean Fourier",
        avatar: "/messages/jeanFourier.png",
        text: `Happy birthday to a truly special girl 🎂❤️
Joyeux anniversaire à toi ! Que Dieu te garde, te guide et remplisse cette nouvelle année de bonheur. 🙏✨
Comme le dit Matthieu 19:14 : « Laissez venir à moi les petits enfants… car le royaume des cieux est pour ceux qui leur ressemblent. » ❤️
Garde toujours cette belle innocence, ton dévouement pour l’enfance, cette joie et cette lumière qui te rendent unique. Et comme dans un bon anime, que ton prochain arc soit rempli de beaux moments, de rires et de victoires. 😂✨

I hope this new chapter brings you happiness, success, peace, and everything your heart deserves.

Happy birthday, girl! ❤️🎉 May your next chapter be legendary!`,
    },

    {
        id: 14,
        name: "Oriane",
        avatar: "/messages/oriane.png",
        text: `Je te souhaite un très joyeux anniversaire à toi Marie - Karel je te souhaite tout plein de bonne choses que en cette nième bougie que tu soufflera que Dieu t’accorde ce dont tu as besoin grandir en âge et en sagesse et que Dieu te bénisse bisous ma chérie.`,
    },

    {
        id: 15,
        name: "Marya",
        avatar: "/messages/marya.png",
        text: `Joyeux anniversaire ma copineeeee,que Dieu t’accorde une belle et longue vie, une vie remplie d’amour et de bonheur. Tu es une personne vraiment très douce et gentille je ne peux que te souhaiter tout ce que je me souhaite à moi. Je prie aussi pour que tu sois toujours heureuse dans ta vie et que Dieu éloigne de toi tout ce qui est vraiment mais vraiment désagréable pour toi. Et encore joyeux anniversaire ma gooo.  petit verset pour toi :
        
        ²Une jolie fleur dans un buisson d'épines, Voilà mon amie parmi les jeunes filles
        
                                                            Cantiques des Cantiques 2:2`,
    },

    {
        id: 16,
        name: "Sam YAO",
        avatar: "/messages/sam.png",
        text: `Il y a des personnes qu’on rencontre sans vraiment savoir quelle place elles vont finir par prendre dans notre vie. Et puis, petit à petit, sans même s’en rendre compte, elles deviennent importantes.

Aujourd’hui, c’est ton jour, et je ne voulais pas simplement te souhaiter « joyeux anniversaire » comme on le fait habituellement. J’avais envie de prendre quelques minutes pour te dire ce que je pense réellement.

Depuis qu’on se connaît, j’ai découvert une personne que j’apprécie de plus en plus. J’aime nos échanges, nos petits moments, nos délires, même ceux qui n’ont parfois aucun sens 😂. J’aime cette complicité qui s’est installée naturellement entre nous, sans qu’on ait eu besoin de la forcer.


Mais une chose est sûre : tu es devenue une personne qui compte pour moi, et je suis vraiment heureux de pouvoir être là pour te souhaiter une belle année de plus.

Je te souhaite beaucoup de bonheur, de réussite, de paix et surtout de belles choses que tu mérites sincèrement. J’espère que cette nouvelle année de ta vie t’apportera des sourires, des opportunités, de beaux souvenirs et des personnes qui sauront te faire du bien.


Profite pleinement de ta journée, fais-toi plaisir et surtout, ne change pas cette belle personne que tu es.

Joyeux anniversaire à toi princesse ❤️.
22 ans, ça se fête quand même… alors aujourd’hui, interdiction de faire semblant d’être raisonnable ou de faire la tête 😑. 

Passe une magnifique journée. Et merci d’être toi. Bisous.
...
ODJE`,
    },
    {
        id: 18,
        name: "Yann Elie",
        avatar: "/messages/yann.png",
        text: `Chère Marie Karel, En ce jour si particulier, je voulais prendre un moment pour te souhaiter un merveilleux anniversaire. Une nouvelle année commence pour toi, et je te souhaite qu'elle soit remplie de joie, de succès et de belles surprises à chaque tournant. 
        Je tiens à te dire à quel point je suis reconnaissant de t'avoir comme camarade. Ta présence, ta bonne humeur et ton soutien comptent énormément pour moi. 
        Les moments partagés avec toi, qu'ils soient simples ou mémorables, sont toujours empreints de complicité, et c'est une vraie chance de t'avoir à mes côtés. 
        J'espère que cette nouvelle année t'apportera tout ce que tu désires : la santé pour avancer sereinement, la réussite dans tes projets, et surtout beaucoup d'amour et de bonheur autour de toi. 
        Que chaque jour te réserve de belles raisons de sourire. Profite pleinement de cette journée qui t'est dédiée, entourée des personnes qui te sont chères. 
        Tu mérites toute la douceur du monde. Encore une fois, joyeux anniversaire ! Avec toute mon affection, Ton ami, Yann Elie`,
    },
    {
        id: 19,
        name: "Ange Djokouri",
